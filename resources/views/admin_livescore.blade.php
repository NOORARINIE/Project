<!DOCTYPE html>
<html lang="en">
<title>Admin | Add Livescore</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="w3-top bgimg">
        <div class="w3-bar w3-black w3-card ">
            ...
            <a href="admin_livescore" class="w3-bar-item w3-button w3-padding-large " style="font-size:25px;">LIVE Score</a>
            <a href="highlights-list" class="w3-bar-item w3-button w3-padding-large " style="font-size:25px;">Highlights</a>
            <a href="livescore-list" class="w3-bar-item w3-button w3-padding-large " style="font-size:25px;">News</a>
            <a href="admin_myaccount" class="w3-bar-item w3-button w3-padding-large " style="font-size:25px;">My Account</a>
        ...
        <div class="container w3-dark-grey " style="padding:20px;">
            <div class="container w3-black" style="padding:20px;">
                <h5>Livescore Management
                    <a class="btn btn-primary" style="float: right;" href="{{route('livescore.list')}}">List Livescore</a>
                </h5>
                <div class="w3-display-container w3-dark-grey" style="height:auto;">
                    <div>
                        <table class="table">
                            ...
                            <tbody>
                                <form class="form" action="{{route('save.livescore')}}" method="POST">
                                    ...
                                    <tr>
                                        <td>
                                            <input class="form-control" type="text" name="Livescore" value="" />
                                        </td>
                                        <td>
                                            <input class="form-control" type="text" name="Team1" value="" />
                                        </td>
                                        <td>
                                            <input class="form-control" type="text" name="Score1" value="" />
                                        </td>
                                        <td>
                                            <input class="form-control" type="text" name="Team2" value="" />
                                        </td>
                                        <td>
                                            <input class="form-control" type="text" name="Score2" value="" />
                                        </td>
                                        <td>
