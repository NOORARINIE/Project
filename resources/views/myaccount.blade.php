      ...
      <div class="container__child signup__form">
        ...
        <form action="#">
          <div class="form-group" style="padding-bottom: 20px">
            <input class="form-control" type="text" name="name" id="name" placeholder="Qudri Ameer"/>
          </div>
          <div class="form-group" style="padding-bottom: 20px">
            <input class="form-control" type="text" name="email" id="email" placeholder="qqqq@gmail.com" />
          </div>
          <div class="form-group" style="padding-bottom: 20px">
            <button style="float: right;" class="w3-button w3-gray" href="changepassword">Change Password</button>
            <input class="form-control" type="password" name="password" id="password" placeholder="*********"/>
          </div>
          <div class="form-group" style="padding-bottom: 20px">
            <input class="form-control" type="text" name="phoneNumber" id="phoneNumber" placeholder="+6018723621"/>
          </div>
        </form>
      </div>
    </div>
