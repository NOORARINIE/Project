<!DOCTYPE html>
<html lang="en">
<title>Admin | Add Highlights</title>
<meta charset="UTF-8">
    ...
    <div class="w3-top bgimg">
        ...
        <div class="container w3-dark-grey " style="padding:20px;">
            <div class="container w3-black" style="padding:20px;">
                <h5>Hightlights Management
                    <a class="btn btn-primary" style="float: right;" href="{{route('highlight.list')}}">List Highlights</a>
                </h5>
                <div class="w3-display-container w3-dark-grey" style="height:auto;">
                    <div>
                        <table class="table">
                            ...
                            <tbody>
                                <form class="form" action="{{route('save.highlight')}}" method="POST">
                                    ...
                                    <tr>
                                        <td>
                                            <input class="form-control" type="text" name="highlights" value="" />
                                        </td>
                                        <td>
